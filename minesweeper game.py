...
class Minesweeper:
    ...
    def __init__(self, tk):
        ...
        # importing  images
        self.images = {
            "plain": PhotoImage(file = "data/tile_plain.gif"),
            "clicked": PhotoImage(file = "data/tile_clicked.gif"),
            "mine": PhotoImage(file = "data/tile_mine.gif"),
            "flag": PhotoImage(file = "data/tile_flag.gif"),
            "wrong": PhotoImage(file = "data/tile_wrong.gif"),
            "numbers": []
        }
        for i in range(1, 9):
            self.images["numbers"].append(PhotoImage(file = "data/img_"+str(i)+".gif"))
    ...
    def gameOver(self, won):
        ...
        msg = "You Win! Do you want to play again?" if won else "You Lose! Do you want to play again?"
